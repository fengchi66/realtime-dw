...
class SpuInfo extends OdsModel {
...
var tm_id: String = _
  ...
  override def toString = s"SpuInfo(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, spu_name=${spu_name}, description=${description}, category3_id=${category3_id}, tm_id=${tm_id})"
