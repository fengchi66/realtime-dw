...
class PaymentInfo extends OdsModel {
...
var callback_content: String = _
  ...
  override def toString = s"PaymentInfo(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, out_trade_no=${out_trade_no}, order_id=${order_id}, user_id=${user_id}, payment_type=${payment_type}, trade_no=${trade_no}, total_amount=${total_amount}, subject=${subject}, payment_status=${payment_status}, create_time=${create_time}, callback_time=${callback_time}, callback_content=${callback_content})"
