...
class BaseCategory2 extends OdsModel {
...
var category1_id: String = _
  ...
  override def toString = s"BaseCategory2(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, name=${name}, category1_id=${category1_id})"
