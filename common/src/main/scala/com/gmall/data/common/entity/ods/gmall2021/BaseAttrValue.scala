...
class BaseAttrValue extends OdsModel {
...
var attr_id: String = _
  ...
  override def toString = s"BaseAttrValue(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, value_name=${value_name}, attr_id=${attr_id})"
