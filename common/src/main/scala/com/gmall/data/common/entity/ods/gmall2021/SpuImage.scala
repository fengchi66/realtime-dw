...
class SpuImage extends OdsModel {
...
var img_url: String = _
  ...
  override def toString = s"SpuImage(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, spu_id=${spu_id}, img_name=${img_name}, img_url=${img_url})"
