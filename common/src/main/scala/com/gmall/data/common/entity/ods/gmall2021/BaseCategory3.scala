...
class BaseCategory3 extends OdsModel {
...
var category2_id: String = _
  ...
  override def toString = s"BaseCategory3(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, name=${name}, category2_id=${category2_id})"
