...
class SpuSaleAttrValue extends OdsModel {
...
var sale_attr_name: String = _
  ...
  override def toString = s"SpuSaleAttrValue(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, spu_id=${spu_id}, base_sale_attr_id=${base_sale_attr_id}, sale_attr_value_name=${sale_attr_value_name}, sale_attr_name=${sale_attr_name})"
