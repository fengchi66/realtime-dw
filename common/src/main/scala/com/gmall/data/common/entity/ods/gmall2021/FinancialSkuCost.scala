...
class FinancialSkuCost extends OdsModel {
...
var busi_date: String = _
var is_lastest: String = _
var sku_cost: String = _
var create_time: String = _
  ...
  override def toString = s"FinancialSkuCost(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, sku_id=${sku_id}, sku_name=${sku_name}, busi_date=${busi_date}, is_lastest=${is_lastest}, sku_cost=${sku_cost}, create_time=${create_time})"
