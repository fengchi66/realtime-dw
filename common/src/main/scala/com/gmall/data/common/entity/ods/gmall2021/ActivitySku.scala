...
class ActivitySku extends OdsModel {
...
var create_time: String = _
  ...
  override def toString = s"ActivitySku(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, activity_id=${activity_id}, sku_id=${sku_id}, create_time=${create_time})"
