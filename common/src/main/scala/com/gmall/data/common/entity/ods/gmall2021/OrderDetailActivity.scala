...
class OrderDetailActivity extends OdsModel {
...
var create_time: String = _
  ...
  override def toString = s"OrderDetailActivity(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, order_id=${order_id}, order_detail_id=${order_detail_id}, activity_id=${activity_id}, activity_rule_id=${activity_rule_id}, sku_id=${sku_id}, create_time=${create_time})"
