...
class BaseRegion extends OdsModel {
...
var region_name: String = _
  ...
  override def toString = s"BaseRegion(database=$database, table=$table, sqlType=$sqlType, ts=$ts, old=$old, id=${id}, region_name=${region_name})"
